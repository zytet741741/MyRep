...
<body>
	...
	<div>
		<a
			href="${pageContext.request.contextPath}/goods/shopCar.do?user_account=${user.account}">购物车</a>
	</div>
	<div>
		<img alt=""
	...
	<div>
		<form action="${pageContext.request.contextPath}/goods/addInCar.do?user_account=${user.account}">
