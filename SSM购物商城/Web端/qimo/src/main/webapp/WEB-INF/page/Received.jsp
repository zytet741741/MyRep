		...
		<tr>
	 	...
	 	<%-- <c:if test="${allSale !=null }">   --%>
			<c:forEach items="${Received }" var="Received">
				<tr>
					<td>${Received.good_name }</td>
					<td>${Received.price }</td>
					<td>${Received.order.count }</td>
					<td>${Received.orderType.status_name }</td>
