...
<body>
	<div align="center">
		...
		<form action="${pageContext.request.contextPath}/user/updateShangJiaInfo.do?account=${user.account}">
			...
			$("#back")
					.on(
							...
							function() {
								...
								window.location.href = "${pageContext.request.contextPath}/user/shangJiaInfo.do?account=${user.account}";
							});
		});
	</script>
</body>
