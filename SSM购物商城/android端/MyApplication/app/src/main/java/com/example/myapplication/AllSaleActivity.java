...
public class AllSaleActivity extends AppCompatActivity {
    ...
    private void jump() {
        ...
        TextView_UnPay.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                Log.d("去付款界面","-------------------------------"+useraccount);

                Intent intent = new Intent(AllSaleActivity.this,UnPayActivity.class);
        ...
        TextView_UnShip.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                Intent intent1 = getIntent();
                useraccount = intent1.getStringExtra("useraccount").toString();
                Log.d("去发货界面","-------------------------------"+useraccount);

                Intent intent = new Intent(AllSaleActivity.this,UnShipActivity.class);
                intent.putExtra("useraccount",useraccount);
                startActivity(intent);
            }
        });
        ...
        TextView_UnReceived.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(AllSaleActivity.this,UnReceivedActivity.class);
                intent.putExtra("useraccount",useraccount);
                startActivity(intent);
            }
        });
        ...
        TextView_UnEvaluated.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(AllSaleActivity.this,UnEvaluatedActivity.class);
                intent.putExtra("useraccount",useraccount);
                startActivity(intent);
            }
        });
        ...
        ImageView_all_myself.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(AllSaleActivity.this,MyselfActivity.class);
                intent.putExtra("useraccount",useraccount);
                startActivity(intent);
            }
        });
        ...
        ImageView_all_shop.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(AllSaleActivity.this,ShopCarActivity.class);
                intent.putExtra("useraccount",useraccount);
                startActivity(intent);
            }
        });
        ...
        ImageView_all_good.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(AllSaleActivity.this,GoodListActivity.class);
                intent.putExtra("useraccount",useraccount);
                startActivity(intent);
            }
        });
    ...
    private void initUnPay() {
        ...
        Log.d("获得得数据","-------------------------------"+useraccount);

        //与WEB端交互
        String address ="http://10.0.2.2:8080/qimo/goods/allSaleJSON.do";
        ...
        OkHttpUtil.postOksendRequestWithOkHttp(address,requestBody, new okhttp3.Callback(){
            ...
            public void onFailure(Call call, IOException e) {
                Toast.makeText(AllSaleActivity.this, "失败", Toast.LENGTH_SHORT).show();
            }
