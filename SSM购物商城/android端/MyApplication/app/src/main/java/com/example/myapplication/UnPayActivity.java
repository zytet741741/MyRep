...
public class UnPayActivity extends AppCompatActivity {
    ...
    private void jump() {
        ...
        TextView_allSale.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(UnPayActivity.this,AllSaleActivity.class);
        ...
        TextView_UnShip.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(UnPayActivity.this,UnShipActivity.class);
                intent.putExtra("useraccount",useraccount);
                startActivity(intent);
            }
        });
        ...
        TextView_UnReceived.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(UnPayActivity.this,UnReceivedActivity.class);
                intent.putExtra("useraccount",useraccount);
                startActivity(intent);
            }
        });
        ...
        TextView_UnEvaluated.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(UnPayActivity.this,UnEvaluatedActivity.class);
                intent.putExtra("useraccount",useraccount);
                startActivity(intent);
            }
        });
        ...
        ImageView_all_myself.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(UnPayActivity.this,MyselfActivity.class);
                intent.putExtra("useraccount",useraccount);
                startActivity(intent);
            }
        });
        ...
        ImageView_all_shop.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                useraccount = intent1.getStringExtra("useraccount").toString();
                Log.d("去个人信息界面","-------------------------------"+useraccount);
                Intent intent = new Intent(UnPayActivity.this,ShopCarActivity.class);
                intent.putExtra("useraccount",useraccount);
                startActivity(intent);
            }
        });
        ...
        ImageView_all_good.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                useraccount = intent1.getStringExtra("useraccount").toString();
                Log.d("去个人信息界面","-------------------------------"+useraccount);
                Intent intent = new Intent(UnPayActivity.this,GoodListActivity.class);
                intent.putExtra("useraccount",useraccount);
                startActivity(intent);
            }
        });
    ...
    private void initUnPay() {
        ...
        //与WEB端交互
        String address ="http://10.0.2.2:8080/qimo/goods/UnpayJSON.do";
        ...
        OkHttpUtil.postOksendRequestWithOkHttp(address,requestBody, new okhttp3.Callback(){
            ...
            public void onFailure(Call call, IOException e) {
                Toast.makeText(UnPayActivity.this, "失败", Toast.LENGTH_SHORT).show();
            }
