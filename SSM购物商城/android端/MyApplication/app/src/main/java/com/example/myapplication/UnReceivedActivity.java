...
public class UnReceivedActivity extends AppCompatActivity {
    ...
    private void jump() {
        ...
        TextView_allSale.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                Log.d("去全部订单界面","-------------------------------"+useraccount);

                Intent intent = new Intent(UnReceivedActivity.this,AllSaleActivity.class);
        ...
        //去待发货界面
        TextView_UnShip.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                Intent intent1 = getIntent();
                String useraccount = intent1.getStringExtra("useraccount").toString();
                Log.d("去待发货界面","-------------------------------"+useraccount);

                Intent intent = new Intent(UnReceivedActivity.this,UnShipActivity.class);
                intent.putExtra("useraccount",useraccount);
                startActivity(intent);
            }
        });
        ...
        TextView_UnReceived.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                Intent intent1 = getIntent();
                String useraccount = intent1.getStringExtra("useraccount").toString();
                Log.d("去待付款界面","-------------------------------"+useraccount);
                Intent intent = new Intent(UnReceivedActivity.this,UnPayActivity.class);
                intent.putExtra("useraccount",useraccount);
                startActivity(intent);
            }
        });
        ...
        TextView_UnEvaluated.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                Intent intent1 = getIntent();
                String useraccount = intent1.getStringExtra("useraccount").toString();
                Log.d("去待评价界面","-------------------------------"+useraccount);

                Intent intent = new Intent(UnReceivedActivity.this,UnEvaluatedActivity.class);
                intent.putExtra("useraccount",useraccount);
                startActivity(intent);
            }
        });
        ...
        ImageView_all_myself.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                Intent intent1 = getIntent();
                useraccount = intent1.getStringExtra("useraccount").toString();
                Log.d("去个人信息界面","-------------------------------"+useraccount);

                Intent intent = new Intent(UnReceivedActivity.this,MyselfActivity.class);
                intent.putExtra("useraccount",useraccount);
                startActivity(intent);
            }
        });
        ...
        ImageView_all_shop.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                Intent intent1 = getIntent();
                useraccount = intent1.getStringExtra("useraccount").toString();
                Log.d("去购物车界面","-------------------------------"+useraccount);

                Intent intent = new Intent(UnReceivedActivity.this,ShopCarActivity.class);
                intent.putExtra("useraccount",useraccount);
                startActivity(intent);
            }
        });
        ...
        ImageView_all_good.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                Intent intent1 = getIntent();
                useraccount = intent1.getStringExtra("useraccount").toString();
                Log.d("去商品界面","-------------------------------"+useraccount);

                Intent intent = new Intent(UnReceivedActivity.this,GoodListActivity.class);
                intent.putExtra("useraccount",useraccount);
                startActivity(intent);
            }
        });
    ...
    private void initUnPay() {
        ...
        //与WEB端交互
        String address ="http://10.0.2.2:8080/qimo/goods/ReceivedJSON.do";
        ...
        OkHttpUtil.postOksendRequestWithOkHttp(address,requestBody, new okhttp3.Callback(){
            ...
            public void onFailure(Call call, IOException e) {
                Toast.makeText(UnReceivedActivity.this, "失败", Toast.LENGTH_SHORT).show();
            }
