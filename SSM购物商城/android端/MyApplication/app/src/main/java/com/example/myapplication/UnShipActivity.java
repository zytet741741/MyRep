...
public class UnShipActivity extends AppCompatActivity {
    ...
    private void jump() {
        ...
        TextView_allSale.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(UnShipActivity.this,AllSaleActivity.class);
        ...
        TextView_UnPay.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(UnShipActivity.this,UnPayActivity.class);
                intent.putExtra("useraccount",useraccount);
                startActivity(intent);
            }
        });
        ...
        TextView_UnReceived.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                Intent intent1 = getIntent();
                String useraccount = intent1.getStringExtra("useraccount").toString();
                Log.d("去待收货界面","-------------------------------"+useraccount);

                Intent intent = new Intent(UnShipActivity.this,UnReceivedActivity.class);
                intent.putExtra("useraccount",useraccount);
                startActivity(intent);
            }
        });
        ...
        TextView_UnEvaluated.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(UnShipActivity.this,UnEvaluatedActivity.class);
                intent.putExtra("useraccount",useraccount);
                startActivity(intent);
            }
        });
        ...
        ImageView_all_myself.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(UnShipActivity.this,MyselfActivity.class);
                intent.putExtra("useraccount",useraccount);
                startActivity(intent);
            }
        });
        ...
        ImageView_all_shop.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(UnShipActivity.this,ShopCarActivity.class);
                intent.putExtra("useraccount",useraccount);
                startActivity(intent);
            }
        });
        ...
        ImageView_all_good.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(UnShipActivity.this,GoodListActivity.class);
                intent.putExtra("useraccount",useraccount);
                startActivity(intent);
            }
        });
    ...
    private void initUnPay() {
        ...
        Log.d("获取传来得数据","-------------------------------"+useraccount);

        //与WEB端交互
        String address ="http://10.0.2.2:8080/qimo/goods/UnshipedJSON.do";
        ...
        OkHttpUtil.postOksendRequestWithOkHttp(address,requestBody, new okhttp3.Callback(){
            ...
            public void onFailure(Call call, IOException e) {
                Toast.makeText(UnShipActivity.this, "失败", Toast.LENGTH_SHORT).show();
            }
